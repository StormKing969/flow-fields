...
const contextVar = canvas.getContext("2d");
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;

// Canvas settings
contextVar.fillStyle = 'white';
contextVar.strokeStyle = 'white';
contextVar.lineWidth = 1;
    ...
    update() {
        ...
        if (this.timer >= 1) {
            ...
            if (this.history.length > this.maxLength) {
                // Removes one element from the beginning of an array
                this.history.shift();
            }
